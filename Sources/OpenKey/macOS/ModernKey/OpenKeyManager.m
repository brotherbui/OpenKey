...
+(BOOL)initEventTap {
    ...
    // Note: CFRunLoopRun() is not needed here because the main run loop
    // is already running (managed by AppKit). The event tap will receive
    // events through the run loop source we added above.
